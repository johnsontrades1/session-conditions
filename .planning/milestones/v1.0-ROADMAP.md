...
**Status:** ✅ Complete (DATA-01 descoped to v2)
...
- [x] All 10 v1 requirements checked off (DATA-01 descoped to v2)
- [x] Page publishes automatically with RTH-clean stats (first unattended fire: next weekday)
- [x] Every surviving label passes CI + stability on RTH data (QQQ, 6,901 days)
